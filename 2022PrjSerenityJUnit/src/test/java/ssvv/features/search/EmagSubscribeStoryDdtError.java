...
@UseTestDataFrom("src/test/resources/emag/EmagErrorSubscribe.csv")
public class EmagSubscribeStoryDdtError {
...
//    }
    ...
    public void subscribeTestDDT() {
        ...
        endUser.should_see_error_subscribe_message(getMessage());
    }
